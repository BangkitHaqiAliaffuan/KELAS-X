...
function getOwnedGames($user_id) {
    global $conn;
...
// In your main content area, replace the existing Quick Launch section with:
?>
<style>
    .sidebar {
        width: 250px;
...
<div class="sidebar">
    ...
    <a href="?menu=library" class="sidebar-item">Library</a>

    <div class="quick-launch">
        <div class="quick-launch-title">QUICK LAUNCH</div>
        <?php
        // Assuming you have the user's ID stored in a session
        if(!isset($_SESSION['user_id'])){
            ...
            $owned_games = getOwnedGames($user_id);
            foreach ($owned_games as $game) {
                ?>
                <a href="?menu=play&id=<?php echo $game['id']; ?>" class="sidebar-item">
                    <img src="./uploads/<?php echo $game['image']; ?>" 
                         width="32" 
            ...
            if (empty($owned_games)) {
                echo '<div class="quick-launch-empty">No games in your library yet</div>';
            }
        }
        ?>
