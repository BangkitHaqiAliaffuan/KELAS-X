...
<body class="bg-[#0A0A0A] text-white">
    <div class=" max-w-4xl mx-auto space-y-8">
        <div class="title-container text-center">
            <h1 class=" title text-4xl font-bold  mb-4
        ...
        <div class="bg-[#121212] rounded-lg overflow-hidden shadow-2xl border border-[#1E1E1E] relative
                ...
                <div class="relative z-10">
                    ...
                    <img src="{{ asset('assets/gamenews.webp') }}" alt="Game News 1" class="w-full h-48 object-cover filter brightness-75 contrast-125">
                    <div class="p-4 bg-gradient-to-r from-[#0F0F0F] to-[#1A1A1A]">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('news1') }}" class="mt-2 inline-block text-[#4A90E2] hover:text-[#6AB0FF] hover:underline bg-[#1A1A1A] px-3 py-1 rounded-full">Read more</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="bg-[#121212] rounded-lg overflow-hidden shadow-2xl border border-[#1E1E1E] relative
                ...
                <div class="relative z-10">
                    <div class="bg-[#1E1E1E] h-1 w-full"></div>
                    <img src="{{ asset('assets/gamenews2.avif') }}" alt="Game News 2" class="w-full h-48 object-cover filter brightness-75 contrast-125">
                    <div class="p-4 bg-gradient-to-r from-[#0F0F0F] to-[#1A1A1A]">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="{{ route('news2') }}" class="mt-2 inline-block text-[#4A90E2] hover:text-[#6AB0FF] hover:underline bg-[#1A1A1A] px-3 py-1 rounded-full">Read more</a>
                        </div>
                    </div>
                </div>
            </div>
